...
<tr valign="top">
	<td>
		...
		<label for="expires"> <?php printf( __( 'Set a <a href="%s" target="_blank">far future HTTP expiration header</a> for uploaded files <em>(recommended)</em>', 'dreamspeed' ), 'http://developer.yahoo.com/performance/rules.html#expires' ); ?></label>
	</td>
</tr>

<tr valign="top">
	<td>
		<label><?php _e( 'Object Path:', 'dreamspeed' ); ?></label>&nbsp;&nbsp;
		...
		<p class="description"><?php _e( 'Your images will be uploaded to this folder structure in your bucket. You can safely change it to anything.', 'dreamspeed' ); ?></p>
	</td>
</tr>
